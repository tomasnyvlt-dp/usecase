      ...
      fields: [
        {
          ...
          options: [
            {
              imgSrc: '/img/car-brands/skoda.svg',
              label: 'Škoda',
              value: 'SKODA',
            },
            {
              imgSrc: '/img/car-brands/wolksvagen.svg',
              label: 'Volkswagen',
              value: 'VOLKSWAGEN',
            },
            {
              imgSrc: '/img/car-brands/ford.svg',
              label: 'Ford',
              value: 'FORD',
            },
            {
              imgSrc: '/img/car-brands/peugeot.svg',
              label: 'Peugeot',
              value: 'PEUGEOT',
            },
            {
              imgSrc: '/img/car-brands/renault.svg',
              label: 'Renault',
              value: 'RENAULT',
            },
            {
              imgSrc: '/img/car-brands/citroen.svg',
              label: 'Citroen',
              value: 'CITROËN',
            },
          ],
