...
import getFilteredFields from '@/schema/components/RestCalculation/utils/getFilteredFields';
import getRequestBody from '@/schema/components/RestCalculation/utils/getRequestBody';
import {
  VALIDATION_ACTIVE_ON_STEPS,
  ignoreFieldsArr,
  vehicleInfoFieldKeys,
} from '@/schema/components/RestValidation/constants';
import { SingleErrorType } from '@/schema/components/RestValidation/types';
import composeRichTextError from '@/schema/components/RestValidation/utils/composeRichTextError';
import getRestErrorsOnCurrentStep from '@/schema/components/RestValidation/utils/getRestErrorsOnCurrentStep';
import getVisibleFieldErrors from '@/schema/components/RestValidation/utils/getVisibleFieldErrors';
import { AutoSjednavacFetchRequestType } from '@/schema/types/AutoSjednavacFetchType';
import config from '@/config';
import debounce from '@/utils/debounce';
import dpApiFetch, { ErrorType } from '@/utils/dpApiFetch';
